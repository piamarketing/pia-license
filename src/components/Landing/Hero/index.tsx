	...
	return (
		<>
			...
			<Box
				...
				borderBottomLeftRadius={{ base: 20, md: 100 }}
				borderBottomRightRadius={{ base: 20, md: 100 }}
			>
				<Container maxW={'3xl'}>
					<Stack
						as={Box}
					...
					>
						...
						>
							...
							<Text
								...
								backgroundClip="text"
								color="transparent"
								backgroundImage={`linear-gradient(rgb(255, 255, 255) 42.31%, rgba(255, 255, 255, 0.5) 94.23%);`}
								w={'100%'}
							>
								your audience
								<Box
